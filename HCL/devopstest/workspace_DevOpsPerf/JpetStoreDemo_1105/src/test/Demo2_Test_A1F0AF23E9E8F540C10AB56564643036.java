...
public class Demo2_Test_A1F0AF23E9E8F540C10AB56564643036 extends LTTestScript  {
...
private HTTPTestScriptHelper httpTestScriptHelper;
	...
	public Demo2_Test_A1F0AF23E9E8F540C10AB56564643036(IContainer container, String invocationId) {
		super(container, "Demo2", invocationId, "A1F0AF23E9E8F540C10AB56564643036", "/JpetStoreDemo_1105/Demo2.testsuite", "C:/Users/rajesh-a/HCL/devopstest/workspace_DevOpsPerf/JpetStoreDemo_1105/Demo2.testsuite");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new HTTPPageTitleVPEvent(), new RPTContinueEvent("Page title verification failed"), 1, "Page title verification failed"));
	...
	this.add(page_5(this));
			this.httpTestScriptHelper.executeHelper();
		     ...
		     log("Test Execution: Demo2_Test_A1F0AF23E9E8F540C10AB56564643036 ",e);
	    } finally {
	        super.execute();
		}	    
    }
	...
	VariableAction vc = new VariableAction(parent, "", "A1F0AF23E9E91C63C10AB56564643036");	
			vars[0] = new DataVar("Demo2_Host", "jpetstore.aspectran.com", IDataArea.TEST, "IGNORE", false, false);

	
		vars[1] = new DataVar("Demo2_Host_1", "assets.aspectran.com", IDataArea.TEST, "IGNORE", false, false);

	
		vars[2] = new DataVar("Demo2_Host_2", "petclinic.aspectran.com", IDataArea.TEST, "IGNORE", false, false);

	
		vars[3] = new DataVar("Demo2_Host_2_Port", "443", IDataArea.TEST, "IGNORE", false, false);

	
		vars[4] = new DataVar("Demo2_Host_1_Port", "443", IDataArea.TEST, "IGNORE", false, false);

	
		vars[5] = new DataVar("Demo2_Host_Port", "443", IDataArea.TEST, "IGNORE", false, false);
		...
		IKAction action = new KAction(parent) {
			...
			public void execute() {
				...
				ConfigConnection conn = new ConfigConnection(
					parent,
					"Config_2",
					(String)(vars[1].getValue()== null?"assets.aspectran.com": (String)vars[1].getValue()),  // host name
		...
		IKAction action = new KAction(parent) {
			...
			public void execute() {
				...
				ConfigConnection conn = new ConfigConnection(
					parent,
					"Config_3",
					(String)(vars[2].getValue()== null?"petclinic.aspectran.com": (String)vars[2].getValue()),  // host name
...
private HTTPPage page_1(final IContainer parent) {
			HTTPThink think = new HTTPThink(0, 1, parent, parent, "A1F0AF23EC95ECDBC10AB56564643036");
	parent.add(think);
	
		HTTPPage page = new HTTPPage(parent, "jpetstore.aspectran.com", "A1F0AF23EC95ECDBC10AB56564643036") {
			...
			{ // Parallal Block Start
				...
				httpParallel.addRequest(0, request_1(this, true, "A1F0AF23EC959EB0C10AB56564643036", false, true,
						"Config_1", "/",	"/", true, false), 0, 100, "null", 3);
				httpParallel.addRequest(1, request_2(this, false, "A1F0AF23ECB9A170C10AB56564643036", false, false,
						"Config_1", "speculation",	"/cdn-cgi/speculation", true, false), 0, 100, "null", 3);
				httpParallel.addRequest(0, request_3(this, false, "A1F0AF23EC959EB0C10AB56564643036", false, false,
						"Config_1", "logo-topbar.gif",	"/images/logo-topbar.gif", true, false), 0, 100, "null", 3);
				httpParallel.addRequest(2, request_4(this, false, "A1F0AF23ECBB4F20C10AB56564643036", false, false,
						"Config_2", "aspectran-site-logo.png",	"/img/aspectran-site-logo.png", true, false), 77, 100, "A1F0AF23EC9613EAC10AB56564643036", 2);
				httpParallel.addRequest(0, request_5(this, false, "A1F0AF23EC959EB0C10AB56564643036", false, false,
						"Config_1", "splash.gif",	"/images/splash.gif", true, false), 0, 100, "null", 3);
				httpParallel.addRequest(3, request_6(this, false, "A1F0AF23ECE3BEB0C10AB56564643036", true, false,
						"Config_3", "pets.png",	"/images/pets.png", true, false), 638, 100, "A1F0AF23EC9613EAC10AB56564643036", 2);
				httpParallel.addRequest(2, request_7(this, false, "A1F0AF23ECBB4F20C10AB56564643036", true, false,
						"Config_2", "aspectran-logo-grey-x100.png",	"/img/aspectran-logo-grey-x100.png", true, false), 115, 100, "A1F0AF23ECE3BEBEC10AB56564643036", 3);
			} // Parallal Block End 
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F0AF23EC9613EAC10AB56564643036", getHTTPTest());
	...
	subContainer_1.addSubInstruction(sub_0);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F0AF23EC9613EDC10AB56564643036",
			true,
			false
		);
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F0AF23ECB9EF92C10AB56564643036", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	subContainer_2.addSubInstruction(sub_2);
		...
		reqAction.addSemaphoreWait((IKAction)myPage.getActionMap().get("A1F0AF23EC9613EAC10AB56564643036"), 3);
		// wait on another action
		reqAction.addSemaphoreWait((IKAction)myPage.getActionMap().get("A1F0AF23EC9613EAC10AB56564643036"), 3);		
		IConnectionRecord serverConnection = ConnectionRecordFactory.find(parent, 
				parallelGroup, connConfigName,
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F0AF23ECB9EF95C10AB56564643036",
			true,
			false
		);
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F0AF23ECBA64D7C10AB56564643036", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	subContainer_3.addSubInstruction(sub_4);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F0AF23ECBA64DAC10AB56564643036",
			true,
			false
		);
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F0AF23ECBB7636C10AB56564643036", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	subContainer_4.addSubInstruction(sub_5);
		ISubRule sub_6 = new SubRule("req_hdr_Host_1", 0, 20, false, (IDCCoreVar)vars[1], false, "Host_10", null, 0, false);
	subContainer_4.addSubInstruction(sub_6);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F0AF23ECBB7639C10AB56564643036",
			true,
			false
		);
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F0AF23ECBC8814C10AB56564643036", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	subContainer_5.addSubInstruction(sub_8);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F0AF23ECBC8817C10AB56564643036",
			true,
			false
		);
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F0AF23ECE3BEBEC10AB56564643036", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	subContainer_6.addSubInstruction(sub_9);
		ISubRule sub_10 = new SubRule("req_hdr_Host_1", 0, 23, false, (IDCCoreVar)vars[2], false, "Host_8", null, 0, false);
	subContainer_6.addSubInstruction(sub_10);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F0AF23ECE3BEC1C10AB56564643036",
			true,
			false
		);
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F0AF23ECE6A4E2C10AB56564643036", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	reqAction.addDataSub(subContainer_7);
		...
		ISubRule sub_11 = new SubRule("req_hdr_Referer_1", 0, 32, false, (IDCCoreVar)dcVars[0], false, "Referer_7", null, 0, false);
	subContainer_7.addSubInstruction(sub_11);
		ISubRule sub_12 = new SubRule("req_hdr_Host_1", 0, 20, false, (IDCCoreVar)vars[1], false, "Host_7", null, 0, false);
	subContainer_7.addSubInstruction(sub_12);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F0AF23ECE6A4E5C10AB56564643036",
			true,
			false
		);
...
private HTTPPage page_2(final IContainer parent) {
			HTTPThink think = new HTTPThink(30826, 1, parent, parent, "A1F0AF23ECE7B650C10AB56564643036");
	parent.add(think);
	
		HTTPPage page = new HTTPPage(parent, "categories_FISH", "A1F0AF23ECE7B650C10AB56564643036") {
			...
			{ // Parallal Block Start
				...
				// httpParallel.addRequest(int serial, HTTPAction action, int actionDelay, String firstCharSemID) 
				httpParallel.addRequest(0, request_8(this, true, "A1F0AF23EC959EB0C10AB56564643036", false, false,
						"Config_1", "FISH",	"/categories/FISH", true, false), 0, 100, "null", 3);
				httpParallel.addRequest(0, request_9(this, false, "A1F0AF23EC959EB0C10AB56564643036", true, true,
						"Config_1", "FISH{1}",	"/categories/FISH", true, false), 116, 100, "A1F0AF23ECE7B654C10AB56564643036", 3);
			} // Parallal Block End 
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F0AF23ECE7B654C10AB56564643036", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	reqAction.addDataSub(subContainer_8);
		...
		ISubRule sub_13 = new SubRule("req_hdr_Referer_1", 0, 32, false, (IDCCoreVar)dcVars[0], false, "Referer_6", null, 0, false);
	...
	subContainer_8.addSubInstruction(sub_14);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F0AF23ECE7B657C10AB56564643036",
			true,
			false
		);
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F0AF23ECE80471C10AB56564643036", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	reqAction.addDataSub(subContainer_9);
		...
		ISubRule sub_15 = new SubRule("req_hdr_Referer_1", 0, 32, false, (IDCCoreVar)dcVars[0], false, "Referer_5", null, 0, false);
	...
	subContainer_9.addSubInstruction(sub_16);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F0AF23ECE80474C10AB56564643036",
			true,
			false
		);
...
private HTTPPage page_3(final IContainer parent) {
			HTTPThink think = new HTTPThink(0, 1, parent, parent, "A1F0AF23ED074C40C10AB56564643036");
	parent.add(think);
	
		HTTPPage page = new HTTPPage(parent, "cdn-cgi_speculation", "A1F0AF23ED074C40C10AB56564643036") {
			...
			{ // Parallal Block Start
				...
				// httpParallel.addRequest(int serial, HTTPAction action, int actionDelay, String firstCharSemID) 
				httpParallel.addRequest(0, request_10(this, true, "A1F0AF23ECB9A170C10AB56564643036", false, true,
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F0AF23ED074C44C10AB56564643036", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	reqAction.addDataSub(subContainer_10);
		...
		ISubRule sub_17 = new SubRule("req_hdr_Referer_1", 0, 47, false, (IDCCoreVar)dcVars[1], false, "Referer_4", null, 0, false);
	...
	subContainer_10.addSubInstruction(sub_18);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F0AF23ED074C47C10AB56564643036",
			true,
			false
		);
...
private HTTPPage page_4(final IContainer parent) {
			HTTPThink think = new HTTPThink(3830, 1, parent, parent, "A1F0AF23ED220038C10AB56564643036");
	parent.add(think);
	
		HTTPPage page = new HTTPPage(parent, "products_FI-SW-02", "A1F0AF23ED220038C10AB56564643036") {
			...
			{ // Parallal Block Start
				...
				// httpParallel.addRequest(int serial, HTTPAction action, int actionDelay, String firstCharSemID) 
				httpParallel.addRequest(0, request_11(this, true, "A1F0AF23ECB9A170C10AB56564643036", false, false,
						"Config_1", "FI-SW-02",	"/products/FI-SW-02", true, false), 0, 100, "null", 3);
				httpParallel.addRequest(0, request_12(this, false, "A1F0AF23ECB9A170C10AB56564643036", false, true,
						"Config_1", "FI-SW-02{1}",	"/products/FI-SW-02", true, false), 72, 100, "A1F0AF23ED22003CC10AB56564643036", 3);
			} // Parallal Block End 
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F0AF23ED22003CC10AB56564643036", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	reqAction.addDataSub(subContainer_11);
		...
		ISubRule sub_19 = new SubRule("req_hdr_Referer_1", 0, 47, false, (IDCCoreVar)dcVars[1], false, "Referer_3", null, 0, false);
	...
	subContainer_11.addSubInstruction(sub_20);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F0AF23ED22003FC10AB56564643036",
			true,
			false
		);
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F0AF23ED22756BC10AB56564643036", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	reqAction.addDataSub(subContainer_12);
		...
		ISubRule sub_21 = new SubRule("req_hdr_Referer_1", 0, 47, false, (IDCCoreVar)dcVars[1], false, "Referer_2", null, 0, false);
	...
	subContainer_12.addSubInstruction(sub_22);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F0AF23ED22756EC10AB56564643036",
			true,
			false
		);
...
private HTTPPage page_5(final IContainer parent) {
			HTTPThink think = new HTTPThink(4, 1, parent, parent, "A1F0AF23ED3DECA0C10AB56564643036");
	parent.add(think);
	
		HTTPPage page = new HTTPPage(parent, "cdn-cgi_speculation {1}", "A1F0AF23ED3DECA0C10AB56564643036") {
			...
			{ // Parallal Block Start
				...
				// httpParallel.addRequest(int serial, HTTPAction action, int actionDelay, String firstCharSemID) 
				httpParallel.addRequest(0, request_13(this, true, "A1F0AF23ECB9A170C10AB56564643036", true, true,
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F0AF23ED3DECA4C10AB56564643036", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
		...
		headers.add(new RequestHeaderData("Sec-Fetch-Mode", "cors", "UTF-8", 1));			
		headers.add(new RequestHeaderData("Sec-Fetch-Dest", "speculationrules", "UTF-8", 1));			
		headers.add(new RequestHeaderData("Referer", "https://jpetstore.aspectran.com/products/FI-SW-02", "UTF-8", 1));			
		headers.add(new RequestHeaderData("Accept-Encoding", "gzip, deflate, br, zstd", "UTF-8", 1));			
		headers.add(new RequestHeaderData("Accept-Language", "en-US,en;q=0.9", "UTF-8", 1));
	...
	reqAction.addDataSub(subContainer_13);
		...
		ISubRule sub_23 = new SubRule("req_hdr_Referer_1", 0, 49, false, (IDCCoreVar)dcVars[2], false, "Referer", null, 0, false);
	...
	subContainer_13.addSubInstruction(sub_24);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F0AF23ED3DECA7C10AB56564643036",
			true,
			false
		);
